...
#    Updated: 2024/09/21 13:15:01 by shurtado         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# Source + obj
SRCS_FILES = minishell.c main.c env/env.c env/utils_env.c blt/cd.c blt/echo.c blt/env.c blt/exit.c blt/export.c blt/pwd.c blt/unset.c
